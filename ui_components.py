                                ...
                                with st.container():
                                    ...
                                    if add_mentors:
                                        ...
                                        if not available_mentors.empty:
                                            ...
                                            group_data.append({'Role': 'Mentor', 'Name': m_name, 'Score': f"{available_mentors.iloc[0]:.1%}"}) # No Emoji
                                            assigned.add(m_name)
                                    ...
                                    if needed > 0:
                                        ...
                                        for name, score in group_learners.items():
                                             group_data.append({'Role': 'Learner', 'Name': name, 'Score': f"{score:.1%}"}) # No Emoji
                                             assigned.add(name)
